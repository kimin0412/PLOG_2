                    ...
                    <v-card class="mx-auto">
                        ...
                        <v-card-text class="grey--text text-center">
                            ...
                            <v-row>
                                ...
                                <v-col v-if="Notes.length > 0" cols="5" class="text-right py-1 pr-5">{{Notes.length}}</v-col>
                        ...
                        <v-expansion-panel>
                            ...
                            <v-expansion-panel-content class="px-0">
                                <v-row class="text-center">
                                    ...
                                    <v-col cols="12" class="py-1"><v-divider></v-divider></v-col>
                                    <v-col cols="12" class="text-caption font-weight-bold black--text py-0">{{myPost}} / {{Notes.length}}</v-col>
                                </v-row>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                        </v-expansion-panels>
                ...
                <v-col cols="9">
                    <v-card class="mx-auto" min-height="71vh">
                        <v-tabs background-color="white" color="grey" centered show-arrows>
                            ...
                            <v-tab>Members</v-tab>
                            <v-tab @click="countPostings">Group Statistics</v-tab>
                            ...
                            <v-tab-item>
                                <v-container>
                                  <v-row>
                                    ...
                                    <v-col cols="2">
                                        <v-card class="mx-auto" min-height="71vh" elevation="0">
                                            <v-card-text class="grey--text text-left">
                                                <v-row class="mt-12">
                                                    ...
                                                    >
                                                      <v-tab class="text-left pa-0 col-8"
                                                      @drop="onDrop($event, 1)"
                                                      @dragover.prevent
                                                      @dragenter.prevent
                                                      ><div class="col-10 text-truncate pa-0">전체 노트</div></v-tab>
                                                      <div v-if="categories.length >= 1">
                                                      <v-tab
                                                        v-for="(category, index) in this.categories"
                                                        :key="index"
                                                        class="text-left pa-0 col-8"
                                                        @click="getNotesInCategory(category.cId)"
                                                        @drop="onDrop($event, category.cId)"
                                                        @dragover.prevent
                                                        @dragenter.prevent
                                                      ><div class="col-10 text-truncate pa-0">
                                                        {{ category.cName }}
                                                      </div></v-tab>
    ...
    created() {
      ...
      .then(({data}) => {
        ...
        data.forEach(element => {
          if(element.pUser == this.$store.state.auth.user.id){
            this.myPost++;
          }
        });
      })
