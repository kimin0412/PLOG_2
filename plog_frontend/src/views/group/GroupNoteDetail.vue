      ...
      <div class="content-center mx-auto">
        ...
        <v-row>
            <v-col cols="12" class="d-flex justify-end py-0 atag">
                ...
                <router-link :to="{ path: '/group/noteUpdate', query:{pId:this.pId, clId:this.groupId}}" class="py-0 text-center" style="text-decoration: none;"> 
            ...
            http.delete('/post/', {
              ...
              .then((response) => {
                if(response.data === 'success'){
                  this.$dialog.notify.success("노트 삭제 완료 🤗", {
