  ...
  <div>
    ...
    <div class="d-none d-sm-block pt-12">
      ...
      <v-container>
        <v-row>
          ...
          <v-col cols="12" class="pt-4 pb-2 text-h6 text-center">404</v-col>
          <v-col cols="12" class="py-0 text-subtitle-2 text-center">page not found </v-col>
        </v-row>
    ...
    <div class="d-block d-sm-none">
      <v-container>
        ...
        <v-row class="mt-7">
          <v-col cols="12" class="py-1 text-subtitle-1 font-weight-bold grey--text">404</v-col>
          <v-col cols="12" class="py-1 text-subtitle-2 grey--text mt-n3">page not found</v-col>
        </v-row>
