...
public interface PostDao extends JpaRepository<Post, Integer> {
	...
	@Modifying
	@Transactional
	@Query(value = "INSERT INTO post (p_id, p_title, p_content, p_user, p_schedule, p_category, p_color, p_club) VALUES (?1, ?2, ?3, ?4, ?5, ?6, ?7, ?8) ", nativeQuery=true)
	int insertPost(int pid, String title, String content, int uid, int schedule, int category, String color, int club);
